 ...
 * Des:
 */
public class MScheduleTermFragment extends AppCompatDialogFragment {
    private OnClickQueryScheduleListenser listenser;
    private static final String TAG = MScheduleTermFragment.class.getSimpleName();
    private View mView;
        ...
        builder.setView(mView)
                ...
                .setPositiveButton(R.string.bt_positive, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // LogUtils.i(TAG, " -- "+ value); 8
                        // LogUtils.i(TAG, date[value]); 2017-2018-1
                        //InquireGradeYearEvent.setDate(date[value]);
                        mConfigManager.setScheduleTerm(date[value]);
                        listenser.onClick();
                    }
                })
                .setNegativeButton(R.string.btn_negative, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        MScheduleTermFragment.this.getDialog().cancel();
    ...
    public void setOnClickQueryScheduleListenser(OnClickQueryScheduleListenser listenser){
        this.listenser = listenser;
    }

    public interface OnClickQueryScheduleListenser{
        void onClick();
    }
}
